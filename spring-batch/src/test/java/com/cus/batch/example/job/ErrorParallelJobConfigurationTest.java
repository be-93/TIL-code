...
@SpringBatchTest
@SpringBootTest(classes = {ErrorParallelJobConfiguration.class, TestBatchConfiguration.class})
class ErrorParallelJobConfigurationTest {
  @Autowired
  ...
  @Test
  @DisplayName("step1 에서 오류가 발생해도 step2 는 정상 수행된다.")
  public void 병렬_처리_스텝_오류_테스트() throws Exception {
    //given
    for (int i = 0; i < 10; i++) {
    ...
    assertAll(
        ...
        () -> assertThat(backUps.size()).isEqualTo(10)
    );
  }
}